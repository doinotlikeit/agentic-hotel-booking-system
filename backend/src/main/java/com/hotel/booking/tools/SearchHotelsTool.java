...
public class SearchHotelsTool extends BaseTool {
        ...
        public Single<Map<String, Object>> runAsync(Map<String, Object> parameters, ToolContext context) {
                return Single.fromCallable(() -> {
                        try {
                                ...
                                log.info("*** Searching hotels in {} (minRating: {}, maxPrice: {})", destination,
                                                minRating, maxPrice);
                                ...
                                Map<String, Object> a2uiResponse = A2UIBuilder.create()
                                                .addJsonTree("Search Results", results, "both", false)
                                                .build();

                                // Return both the A2UI response AND a marker for the agent to detect
                                // The agent will cache this and send it to the frontend
                                Map<String, Object> response = new HashMap<>(a2uiResponse);
                                response.put("__a2ui_direct__", true);
        ...
        private static List<Hotel> getHotelsByDestination(String destination) {
                ...
                if (destination.toLowerCase().contains("paris")) {
                        ...
                        hotels.add(
                                        new Hotel("Eiffel View Hotel", "Paris", "H002", 4.0, 180.0,
                        ...
                        hotels.add(
                                        new Hotel("Manhattan Grand", "New York", "H007", 4.7, 400.0,
                        ...
                        hotels.add(
                                        new Hotel("Times Square Hotel", "New York", "H009", 4.5, 350.0,
