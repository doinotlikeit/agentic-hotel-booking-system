...
The `adk-root-agent` automatically discovers this A2A agent and exposes the `bookHotel` skill as a tool. When a user asks to book a hotel, the agent will route the request through A2A to this service.
